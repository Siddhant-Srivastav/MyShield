...
const guidelines = [
  { id: 1, text: "Patient को करवट में लिटाएं और airway clear रखें।", emoji: "🛌" },
  { id: 2, text: "Patient को unnecessary move ना करें, especially affected arm या leg को forcefully move ना कराएं।", emoji: "🛑" },
  { id: 3, text: "Patient को कुछ भी खाने-पीने को ना दें, जब तक doctor advice ना दे।", emoji: "🚫" },
  { id: 4, text: "कोई medicine, जैसे aspirin, खुद से ना दें — सिर्फ doctor की advice पर ही दें।", emoji: "💊" },
  { id: 5, text: "Oil massage या कोई घरेलू उपाय ना करें।", emoji: "🙅" },
  { id: 6, text: "Symptoms शुरू होने के time को note करें — यह doctor के लिए बहुत important होता है।", emoji: "🕐" },
  { id: 7, text: "Patient को अकेला ना छोड़ें। उनके साथ रहें और उन्हें शांत रखने की कोशिश करें।", emoji: "🤝" },
  { id: 8, text: "Patient को गहरी सांस लेने को कहें और उन्हें calm रखें।", emoji: "🫁" },
];

const SPEECH_TEXT =
  "Sudden paralysis आपातकालीन मार्गदर्शन। " +
  guidelines.map((g) => g.text).join(" ") +
  " यह मार्गदर्शन अस्थायी आपातकालीन सहायता है और पेशेवर चिकित्सा उपचार का विकल्प नहीं है।";

export default function ParalysisScreen() {
    ...
    <SafeAreaView style={styles.safe} edges={["top"]}>
      ...
      >
        ...
        <View style={styles.headingRow}>
          <View style={styles.paralysisCircle}>
            <Text style={styles.paralysisEmoji}>🦽</Text>
          </View>
          <View style={{ flex: 1 }}>
            <Text style={styles.heading}>Sudden Paralysis</Text>
